...
public class HomeActivity extends SherlockListActivity {
    private List<ActivityInfo> activitiesInfo = Arrays.asList(
            new ActivityInfo(ListViewSampleActivity.class, R.string.activity_title_listview),
            new ActivityInfo(ScrollViewSampleActivity.class, R.string.activity_title_scrollview));
